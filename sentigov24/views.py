...
def get_data(request):
    ...
    context['series'] = {1: [{'name': 'Negative', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Positive', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Neutral', 'data': [1, 1, 1, 1, 1, 1, 1]}], 
                         ...
                         5: [{'name': 'Negative', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Positive', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Neutral', 'data': [1, 1, 1, 1, 1, 1, 1]}], 
                         6: [{'name': 'Negative', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Positive', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Neutral', 'data': [1, 1, 1, 1, 1, 1, 1]}], 
                         7: [{'name': 'Negative', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Positive', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Neutral', 'data': [1, 1, 1, 1, 1, 1, 1]}], 
                         8: [{'name': 'Negative', 'data': [1, 1, 1, 2, 1, 1, 1]}, {'name': 'Positive', 'data': [1, 1, 1, 0, 1, 1, 1]}, {'name': 'Neutral', 'data': [1, 1, 1, 1, 1, 1, 1]}], 
                         9: [{'name': 'Negative', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Positive', 'data': [1, 1, 1, 1, 1, 1, 1]}, {'name': 'Neutral', 'data': [1, 1, 1, 1, 1, 1, 1]}], 
                         10: [{'name': 'Negative', 'data': [1, 1, 1, 1, 226, 248, 1]}, {'name': 'Positive', 'data': [1, 1, 2, 1, 225, 326, 1]}, {'name': 'Neutral', 'data': [1, 1, 0, 1, 86, 115, 1]}]}
